<?
// hirezpiesiniubuferio browsinimas su piesiniais
...
<span class="ilink"><a href="http://art.scene.lt" class="ilink">art.scene</a> &gt;&gt; <a href="hirez.php3" class="ilink">senoji piešinių galerija</a></span><br><br>
...
<?
;}//while
 if (!$i) {echo "Žiūrovų atsiliepimų dar nėra <br><br>";}
?>
...
<tr>
	...
	<td><input type=text name=email size=50></td>
     ...
     <span class="text"> *komentaras:<br>
      ...
      <div align="right"> <input type=submit value="siųsti">  <input type=reset value="ištrinti"></div>
</span>
    </form>
</td></tr></table>
</td></tr></table>
